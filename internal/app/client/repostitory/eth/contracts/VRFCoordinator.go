...
// CreateSubscription0 is a paid mutator transaction binding the contract method 0xe375c0d6.
//
// Solidity: function createSubscription(address subscriber) returns(uint64)
func (_Vrf *VrfTransactor) CreateSubscription0(opts *bind.TransactOpts, subscriber common.Address) (*types.Transaction, error) {
	return _Vrf.contract.Transact(opts, "createSubscription0", subscriber)
}

// CreateSubscription0 is a paid mutator transaction binding the contract method 0xe375c0d6.
//
// Solidity: function createSubscription(address subscriber) returns(uint64)
func (_Vrf *VrfSession) CreateSubscription0(subscriber common.Address) (*types.Transaction, error) {
	return _Vrf.Contract.CreateSubscription0(&_Vrf.TransactOpts, subscriber)
}

// CreateSubscription0 is a paid mutator transaction binding the contract method 0xe375c0d6.
//
// Solidity: function createSubscription(address subscriber) returns(uint64)
func (_Vrf *VrfTransactorSession) CreateSubscription0(subscriber common.Address) (*types.Transaction, error) {
	return _Vrf.Contract.CreateSubscription0(&_Vrf.TransactOpts, subscriber)
}
